...
export function LogicNode({ data }: { data: { label: string; tag?: string } }) {
    return (
        <div className="bg-card rounded-xl shadow-xl border border-primary p-4 relative ring-4 ring-border transition-all transform scale-[1.02] w-[200px] group">
            ...
            <div className="flex items-center justify-between mb-2">
                ...
                <GitBranch className="text-muted-foreground/50 w-3.5 h-3.5" />
            </div>
