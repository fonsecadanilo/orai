/**
 * Script para popular a tabela ux_blocks com os 50 blocos UX
 */

// Dados dos blocos extraídos do JSON fornecido
const uxBlocks = [
  {
    id: "login-basic",
    label: "Login Básico",
...
// Script para popular via SQL direto
console.log("-- Script SQL para popular ux_blocks\n");
console.log("BEGIN;\n");

uxBlocks.forEach((block) => {
